    ...
    <main class="mx-auto w-full max-w-5xl px-4 pb-16">
        <div class="max-w-md mx-auto">
            <div class="border border-slate-200 rounded-2xl bg-white p-6 shadow-sm">
                <h1 class="text-2xl font-semibold mb-4">Register a New Account</h1>
                    ...
                    <div>
                        ...
                        <div class="mt-2 flex items-center gap-2">
                            <input type="password" name="password_confirmation" value="{{ old('password_confirmation') }}"
                                required class="w-full px-3 py-2 border rounded-md bg-transparent" />
                ...
                <p class="text-sm mt-4">Already have an account? <a href="{{ url('/login') }}"
                        class="text-emerald-600 hover:underline">Login</a></p>
            </div>
        </div>
    </main>
@endsection
